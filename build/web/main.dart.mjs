...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm} = {}) {
    ...
    const dart2wasm = {
      ...
      _1622: () => globalThis.removeSplashFromWeb(),
      ...
      _1725: s => JSON.stringify(s),
      _1726: s => printToConsole(s),
      _1727: a => a.join(''),
      _1730: (s, t) => s.split(t),
      ...
      _1734: s => s.trimLeft(),
      _1735: s => s.trimRight(),
      _1737: (s, p, i) => s.indexOf(p, i),
      _1738: (s, p, i) => s.lastIndexOf(p, i),
      _1740: Object.is,
      ...
      _1756: (a, i) => a[i],
      _1757: (a, i, v) => a[i] = v,
      _1759: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1760: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1761: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1762: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1763: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1764: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1765: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      ...
      _1769: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1770: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1771: (t, s) => t.set(s),
      ...
      _1801: () => globalThis.performance,
      _1802: () => globalThis.JSON,
      _1803: x0 => x0.measure,
      _1804: x0 => x0.mark,
      _1805: x0 => x0.clearMeasures,
      _1806: x0 => x0.clearMarks,
      _1807: (x0,x1,x2,x3) => x0.measure(x1,x2,x3),
      _1808: (x0,x1,x2) => x0.mark(x1,x2),
      _1809: x0 => x0.clearMeasures(),
      _1810: x0 => x0.clearMarks(),
      _1811: (x0,x1) => x0.parse(x1),
      _1812: (o, t) => o instanceof t,
      ...
      _1816: o => Object.keys(o),
      _1817: (ms, c) =>
      setTimeout(() => dartInstance.exports.$invokeCallback(c),ms),
      _1818: (handle) => clearTimeout(handle),
      _1821: (c) =>
      ...
      _1872: x0 => x0.pop(),
      _1874: o => o === undefined,
      _1893: o => typeof o === 'function' && o[jsWrappedDartFunctionSymbol] === true,
      _1895: o => {
        const proto = Object.getPrototypeOf(o);
        return proto === Object.prototype || proto === null;
      },
      _1896: o => o instanceof RegExp,
      _1897: (l, r) => l === r,
      _1898: o => o,
      _1899: o => o,
      _1900: o => o,
      ...
      _1902: o => o.length,
      _1905: (o, i) => o[i],
      _1906: f => f.dartFunction,
      _1907: l => arrayFromDartList(Int8Array, l),
      _1908: l => arrayFromDartList(Uint8Array, l),
      _1909: l => arrayFromDartList(Uint8ClampedArray, l),
      _1910: l => arrayFromDartList(Int16Array, l),
      _1911: l => arrayFromDartList(Uint16Array, l),
      _1912: l => arrayFromDartList(Int32Array, l),
      _1913: l => arrayFromDartList(Uint32Array, l),
      _1914: l => arrayFromDartList(Float32Array, l),
      _1915: l => arrayFromDartList(Float64Array, l),
      _1916: x0 => new ArrayBuffer(x0),
      _1917: (data, length) => {
      ...
      _1918: l => arrayFromDartList(Array, l),
      _1919: () => ({}),
      _1920: () => [],
      _1921: l => new Array(l),
      _1922: () => globalThis,
      ...
      _1960: x0 => x0.random(),
      _1961: x0 => x0.random(),
      _1965: () => globalThis.Math,
      _1967: Function.prototype.call.bind(Number.prototype.toString),
      _1968: (d, digits) => d.toFixed(digits),
      _1971: (d, precision) => d.toPrecision(precision),
      _3842: () => globalThis.window,
      _6545: x0 => x0.signal,
      _8449: x0 => x0.value,
      _8451: x0 => x0.done,
      _9174: x0 => x0.url,
